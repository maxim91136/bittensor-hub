...
## 🎯 Headline Feature: Block Time & Staking APR Metrics
...
- **Formula**: `Σ(APR × stake) / Σ(stake)` across top 50 validators
- **Per-validator APR**: `(daily_return × 365 / stake) × 100`
...
**Full Changelog**: [v1.0.0-rc.12...v1.0.0-rc.13](https://github.com/maxim91136/bittensor-labs/compare/v1.0.0-rc.12...v1.0.0-rc.13)
