...
## Added
- `backup_issuance_history.py` enhanced to prefer S3 (R2) when keys are present and fall back to Cloudflare HTTP API when not. Uploads are opt‑in via `ENABLE_R2`.
